...
//	public Integer removeGoodsClassById(@Param(value = "id") Long id)throws Exception;
	...
	List<GoodsClass> queryByUser(Map<String,Object> params);

	Integer queryCountByUser(MerchantInfo merchantInfo);

	Integer saveGoodsClass (GoodsClass goodsClass);

	Integer modifyGoodsClass(GoodsClass goodsClass);

	Integer removeGoodsClassById(GoodsClass goodsClass);
